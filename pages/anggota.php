...
<div id="content">
	...
	<p id="tombol-tambah-container"><a href="index.php?p=anggota-input" class="btn btn-info">Tambah Anggota</a>
	<a target="_blank" href="pages/cetak.php"><img src="images/print.png" height="50px"></a>

	<form class="form-inline" method="POST">
		<div style="tex-align:right">
			<form method=post>
	...
	<table id="tabel-tampil" class="table">
